...
import gov.sec.cas.core.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    public ExtendedMetadataDelegate extendedMetadataProvider()
        ...
        FilesystemMetadataProvider filesystemMetadataProvider = new FilesystemMetadataProvider(this.backgroundTaskTimer,
                idpXML.getFile());
